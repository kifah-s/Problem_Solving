...
/* >>> Program Sum First Two Numbers And Multiply Last Numbers ( Version 5 ) <<< */
...
int main()
{
    ...
    sum_fun(get_sec_num_fun(), get_fir_num_fun());
    mul_fun(get_for_num_fun(), get_thi_num_fun());
...
void wel_mas_function()
{
    printf("\n\nYou welcome in Program Sum First Two Numbers And Multiply Last Numbers ( Version 5 ) ..\n\n");
}
