...
/* >>> Sum 4 Numbers Program In Separate Lines ( Version 6 ) <<< */
...
int main()
{
    printf("\n\nYou welcome in Sum 4 Numbers Program In Separate Lines ( Version 6 ) ..\n\n");

    int num_1 = 1, num_2 = 2, num_3 = 3, num_4 = 4;

    int result_1 = num_1 + num_2, result_2 = num_3 + num_4;
