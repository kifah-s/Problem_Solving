...
/* >>> Sum Five Numbers Program ( Version 3 ) <<< */
...
int main()
{
    ...
    sumNumFun(fiveNumFun(), forthNumFun(), thirdNumFun(), secondNumFun(), firstNumFun());
...
void welMasFun()
{
    printf("\nYou welcome in Sum Five Numbers Program ( Version 3 ) ..\n\n");
}
