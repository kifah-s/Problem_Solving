...
/* >>> program Sum numbers and multiply them ( Version 12 ) <<< */
...
int res_tot_mul_num3_fun(int result_1, int num_3);
...
int main()
{
    ...
    int sum = res_sum_num1_and_num2_fun(num_1, num_2);

    res_tot_mul_num3_fun(sum, num_3);
...
void wel_mas_fun()
{
    printf("\n\nYou welcome in program Sum numbers and multiply them ( Version 12 ) ..\n\n");
}
