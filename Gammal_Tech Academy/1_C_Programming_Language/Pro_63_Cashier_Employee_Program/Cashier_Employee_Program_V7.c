...
/* >>> Cashier Employee Program ( Version 7 ) <<< */
...
int fiscalDeficit(int tenteredToday, int totalPhone, int totalTv, int totalMicrowave, int totalLaptop, int totalFridge);
...
void welMasFun()
{
    printf("\n\nYou welcome in Cashier Employee program ( Version 7 ) ..\n\n");
}
...
int fiscalDeficit(int tenteredToday, int totalPhone, int totalTv, int totalMicrowave, int totalLaptop, int totalFridge)
{
    ...
    fiscalDeficit = tenteredToday - totalPhone - totalTv - totalMicrowave - totalLaptop - totalFridge;
    printf("\nFiscal deficit : %d $\n\n\n", fiscalDeficit);
}