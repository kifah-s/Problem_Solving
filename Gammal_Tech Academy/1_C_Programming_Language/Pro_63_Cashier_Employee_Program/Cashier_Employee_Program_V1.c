...
/* >>> Cashier Employee Program ( Version 1 ) <<< */
...
int main()
{
    printf("\n\nYou welcome in Cashier Employee Program ( Version 1 ) ..\n\n");
    ...
    fiscal_deficit = tentered_today - (phone * s_phone) - (tv * s_tv) - (microwave * s_microwave) - (laptop * s_laptop) - (fridge * s_fridge);
    printf("\nFiscal deficit : %d $\n\n\n", fiscal_deficit);
