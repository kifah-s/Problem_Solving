...
int main()
{
    ...
    int first_num = get_fri_num_fun();
    int second_num = get_sec_num_fun();
    int third_num = get_thi_num_fun();

    int sum = sum_fri_sec_fun(first_num, second_num);
    mult_fun(sum, third_num);
