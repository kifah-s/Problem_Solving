...
/* >>> Calculate Length Growth Rate Program ( Version 5 ) <<< */
...
int lengthNowFun();
int lengthYearFun();
int calculateFun(int lengthNow, int lengthYear);
...
int main()
{
    ...
    calculateFun(lengthNow, lengthYear);
...
void welcomeMassageFun()
{
    printf("\n\nYou welcome in Calculate Length Growth Rate Program ( Version 5 ) ..\n\n");
}
