...
int totalFun(int mathematics, int arabic, int chemistry, int history, int geography, int physics);
...
int main()
{
    ...
    totalFun(mathematics, arabic, chemistry, history, geography, physics);
