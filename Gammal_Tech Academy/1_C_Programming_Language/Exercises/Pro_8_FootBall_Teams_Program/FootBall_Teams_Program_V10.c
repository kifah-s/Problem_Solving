...
/* >>> FootBall Teams Program ( Version 10 ) <<< */
...
int main()
{
    ...
    /* printf(foo_tea_fun()); */
    printf("%s", foo_tea_fun());

    /* printf(matches_1_fun()); */
    printf("%s", matches_1_fun());

    /* printf(matches_2_fun()); */
    printf("%s", matches_2_fun());

    /* printf(matches_3_fun()); */
    printf("%s", matches_3_fun());
...
char *wel_mas_fun()
{
    char *wel_mas[] = {"\n\nYou welcome in FootBall Teams Program ( Version 10 ) ..\n\n"};
    return *wel_mas;
}
