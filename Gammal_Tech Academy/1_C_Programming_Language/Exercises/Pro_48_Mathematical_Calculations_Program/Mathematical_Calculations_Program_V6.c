...
/* >>> Mathematical Calculations Program ( Version 6 ) <<< */
...
int main()
{
    ...
    int result = mathCalcFun(forthNumFun(), thirdNumFun(), secondNumFun(), firstNumFun());
...
void welMasFun()
{
    printf("\n\nYou welcome in Mathematical Calculations Program ( Version 6 ) ..\n\n");
}
