...
/* >>> Program Collect 4 Numbers In Different Lines ( Version 8 ) <<< */
...
int sum_num1_num2_fun(int num_1, int num_2);
int sum_num3_num4_fun(int num_3, int num_4);
...
int main()
{
    ...
    sum_num1_num2_fun(num_1, num_2);
    sum_num3_num4_fun(num_3, num_4);
...
void wel_mas_function()
{
    printf("\n\nYou welcome in Program Collect 4 Numbers In Different Lines ( Version 8 ) ..\n\n");
}
...
// Sum firs number and second number function;
int sum_num1_num2_fun(int num_1, int num_2)
{
...
// Sum third number and forth number function;
int sum_num3_num4_fun(int num_3, int num_4)
{
    int result = num_3 + num_4;
    printf("\nThe result of adding the third number and the forth number is : %d\n\n\n", result);
}