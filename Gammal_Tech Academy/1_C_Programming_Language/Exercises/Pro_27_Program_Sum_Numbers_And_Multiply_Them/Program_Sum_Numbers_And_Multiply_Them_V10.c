...
/* >>> program Sum numbers and multiply them ( Version 10 ) <<< */
...
int main()
{
    ...
    res_sum_num1_and_num2_fun(num_1, num_2);
    res_tot_mul_num3_fun(num_3);
...
void wel_mas_fun()
{
    printf("\n\nYou welcome in program Sum numbers and multiply them ( Version 10 ) ..\n\n");
}
