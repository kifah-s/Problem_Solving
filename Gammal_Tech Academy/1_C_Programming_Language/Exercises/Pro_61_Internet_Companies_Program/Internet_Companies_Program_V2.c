...
/* >>> Internet Companies Program ( Version 2 ) <<< */
...
int newPacFun(int monthlySub, int residual);
...
void welMasFun()
{
    printf("\n\nYou welcome in Internet Companies Program ( Version 2 ) ..\n\n");
}
