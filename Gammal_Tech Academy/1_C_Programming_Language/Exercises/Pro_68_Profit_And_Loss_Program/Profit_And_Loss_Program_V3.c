...
/* >>> Profit And Loss Program ( Version 3 ) <<< */
...
int differenceFunction(int amountMoney, int afterMonth);
...
int main()
{
    ...
    differenceFunction(amountMoney, afterMonth);
...
void welcomeMassageFun()
{
    printf("\n\nYou welcome in Profit And Loss Program ( Version 3 ) ..\n\n");
}
