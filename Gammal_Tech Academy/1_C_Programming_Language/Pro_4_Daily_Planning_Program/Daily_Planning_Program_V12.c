...
/* >>> Daily Planning Program ( Version 12 ) <<<*/
...
int main()
{
    ...
    printf("%s", university_fun());

    /* printf(english_fun()); */
    printf("%s", english_fun());
    ...
    /* printf(private_fun()); */
    printf("%s", private_fun());

    /* printf(sleeping_fun()); */
    printf("%s", sleeping_fun());
...
char *welcome_massage()
{
    char *wel_mas[] = {"\n\nYou welcome in Daily Planning Program ( Version 12 ) ..\n\n"};
