...
/* >>> Individual Positions Program ( Version 3 ) <<< */
...
int *getNumbersFun();
int individualPositionsFun(int *array);
...
void welcomeMassageFun()
{
    printf("\n\nYou welcome in Individual Positions Program ( Version 3 ) .. \n\n");
}
