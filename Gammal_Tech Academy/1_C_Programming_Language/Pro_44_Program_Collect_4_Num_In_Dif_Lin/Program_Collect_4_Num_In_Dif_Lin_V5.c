...
/* >>> Program Collect 4 Numbers In Different Lines ( Version 5 ) <<< */
...
int main()
{
    ...
    int sum_num1_num2 = sum_num_fun(num_1, num_2);
    int sum_num3_num4 = sum_num_fun(num_3, num_4);
...
void wel_mas_function()
{
    printf("\n\nYou welcome in Program Collect 4 Numbers In Different Lines ( Version 5 ) ..\n\n");
}
