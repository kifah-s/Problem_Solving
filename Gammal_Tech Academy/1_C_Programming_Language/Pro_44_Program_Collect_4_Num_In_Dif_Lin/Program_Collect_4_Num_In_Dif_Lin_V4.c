...
/* >>> Program Collect 4 Numbers In Different Lines ( Version 4 ) <<< */
...
void wel_mas_function()
{
    printf("\n\nYou welcome in Program Collect 4 Numbers In Different Lines ( Version 4 ) ..\n\n");
}
