...
short GetPeriodLengthInDays(stDate date1, stDate date2, bool includeEndDay = false)
{
    short days = 0;
...
int main()
{
    ...
    cout << "\nPeriod Length Is:" << GetPeriodLengthInDays(period.startDate, period.endDate) << endl;
    cout << "Period Length (Including End Date) Is:" << GetPeriodLengthInDays(period.startDate, period.endDate, true) << endl;
