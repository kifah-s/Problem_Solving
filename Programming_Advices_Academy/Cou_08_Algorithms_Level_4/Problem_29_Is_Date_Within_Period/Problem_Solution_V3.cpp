...
bool IsDateWithinPeriod(stDate date, stPeriods period)
{
    return !(CompareDates(date, period.startDate) == enDateCompare::date1BeforDate2 || CompareDates(date, period.endDate) == enDateCompare::date1AfterDate2);
}
