...
bool IsDateWithinPeriod(stPeriods period, stDate date)
{
    if (CompareDates(period.startDate, date) == enDateCompare::date1BeforDate2 && CompareDates(period.endDate, date) == enDateCompare::date1AfterDate2 || CompareDates(period.startDate, date) == enDateCompare::date1EqualDate2 || CompareDates(period.endDate, date) == enDateCompare::date1EqualDate2)
    {
        return true;
    }
...
int main()
{
    ...
    cout << "Please, enter period: " << endl;
    period = ReadPeriods();

    cout << "Please, enter Date To Check: " << endl;
    date = ReadFullDate();
