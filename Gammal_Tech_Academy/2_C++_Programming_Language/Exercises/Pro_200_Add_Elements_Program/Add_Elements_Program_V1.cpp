...
//* Add Elements Program (Version 1).

/*
* Write a program to Add the elements 5, 9, 200, and -3 to a vector.

! Output:
! Elements in vector: 5 9 200 -3
*/
...
{
    cout << "\n\nYou welcome in Add Elements Program (Version 1) ..\n"
         << endl;
}
