...
{
    cout << "\n\nYou welcome in Adds Words Program (Version 1) ..\n"
         << endl;
}
...
vector<string> addNewWordToVectorFun(vector<string> myVec, string newWord1, string newWord2)
{
    myVec.push_back(newWord1);
    myVec.push_back(newWord2);

    cout << "\n\nThe word \"" << newWord1 << "\"" << " and \"" << newWord2 << "\" has been added to the dictionary.\n"
         << endl;
...
void resultFun()
{
    ...
    myVector = addNewWordToVectorFun(myVector, myWord1, myWord2);
