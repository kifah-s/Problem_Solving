...
//* Find Pair Of Numbers 8 Program (Version 1).

/*
* Modify the previous program to handle cases where there are multiple pairs of numbers whose difference is equal to the user-entered value z,
...
{
    cout << "\n\nYou welcome in Find Pair Of Numbers 8 Program (Version 1) ..\n"
         << endl;
}
