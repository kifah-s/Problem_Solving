...
//* Adds Word Program (Version 1).

/*
* Write a program that adds the word "good" to the dictionary.

* hello, hi, ok

! Output:
! The word "good" has been added to the dictionary.
*/
...
{
    cout << "\n\nYou welcome in Adds Word Program (Version 1) ..\n"
         << endl;
}
...
{
    cout << "Vector Befor Add New Word: ";
...
vector<string> addNewWordToVectorFun(vector<string> myVec, string newWord)
{
    ...
    cout << "\n\nThe word \"" << newWord << "\" has been added to the dictionary.\n"
         << endl;
...
{
    cout << "Vector After Add New Word: ";
    for (int i = 0; i < myVec.size(); i++)
    {
        cout << myVec[i] << ", ";
    }
