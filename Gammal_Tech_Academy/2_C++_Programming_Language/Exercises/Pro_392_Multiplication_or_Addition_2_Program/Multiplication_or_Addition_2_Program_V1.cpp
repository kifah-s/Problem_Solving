...
//* Multiplication or Addition 2 Program (Version 1).

/*
* Modify the previous program to handle cases where there are multiple
* pairs of numbers whose multiplication or addition is equal to the user-entered value z.
...
{
    cout << "\n\nYou welcome in Multiplication or Addition 2 Program (Version 1) ..\n"
         << endl;
}
