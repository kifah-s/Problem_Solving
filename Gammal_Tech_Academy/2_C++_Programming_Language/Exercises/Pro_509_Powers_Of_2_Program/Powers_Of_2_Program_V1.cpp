...
{
    cout << "\n\nYou welcome in Powers Of 2 Program (Version 1) ..\n"
         << endl;
}
...
void printFuc(int x)
{
    int pow = powerOfTwoFun(x);
    cout << "Power of 2 for " << x << ": " << pow << endl;
}
