...
//* Find Pair Of Numbers 3 Program (Version 1).

/*
* Write a program to find pairs of numbers from vectors x and y whose division result is equal to the user-entered value z,
...
{
    cout << "\n\nYou welcome in Find Pair Of Numbers 3 Program (Version 1) ..\n"
         << endl;
}
