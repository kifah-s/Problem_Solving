...
/* >>> Particular Element Program ( Version 1 ) <<< */
...
int main()
{
     ...
     // Check if particular element existing in set .
     for (auto k : mySet)
     {
          if (k == parElement)
          {
     ...
     // Print particular element if existing in set.
     if (find)
     {
          cout << "Find particular element in set";
     }
     else
     {
...
void welcomeMassageFun()
{
     cout << endl
          << endl
          << "You welcome inParticular Element Program ( Version 1 ) .." << endl
          << endl;
}
// ... End Functions ...