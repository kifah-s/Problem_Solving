...
//* Country And Inhabitants Program (Version 1).

/*
* Create a set of pairs to store country names along with the number of inhabitants. Print the sorted pairs.
...
{
    cout << "\n\nYou welcome in Country And Inhabitants Program (Version 1) ..\n"
         << endl;
}
