...
//* Find Pair Of Numbers 9 Program (Version 1).

/*
* Write a program that works with vectors x and y, each containing a set of numbers.
* The program should take a user input value z and check if there exist any pair of numbers (one from x and one from y) whose difference or sum is equal to z,
...
{
    cout << "\n\nYou welcome in Find Pair Of Numbers 9 Program (Version 1) ..\n"
         << endl;
}
