...
//* Reverses Word Program (Version 3).
...
{
    cout << "\n\nYou welcome in Reverses Word Program (Version 3) ..\n"
         << endl;
}
...
string reversedWordFun(string w, string revWo)
{
...
void resultFun()
{
    ...
    reverseWord = reversedWordFun(word, reverseWord);
