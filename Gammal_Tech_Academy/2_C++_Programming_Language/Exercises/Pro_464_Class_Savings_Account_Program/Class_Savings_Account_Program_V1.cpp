...
//* Class Savings Account Program (Version 1).
...
public:
    ...
    {
        interestRate = balance * 0.05;
        cout << "Interest earned: " << interestRate << "$" << endl;
    }
};
//* End Classes ..
...
{
    cout << "\n\nYou welcome in Class Savings Account Program (Version 1) ..\n"
         << endl;
}
