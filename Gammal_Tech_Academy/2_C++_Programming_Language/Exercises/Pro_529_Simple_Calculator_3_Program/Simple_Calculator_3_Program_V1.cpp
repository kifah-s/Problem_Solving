...
//* Simple Calculator 3 Program (Version 1).

/*
* Write a program for a continuous arithmetic calculator.
* The program should use a while loop to continuously prompt the user to enter two numbers
* and an arithmetic operation (+, -, *, /).
* It should then perform the requested operation and display the result.
...
{
    cout << "\n\nYou welcome in Simple Calculator 3 Program (Version 1) ..\n"
         << endl;
}
