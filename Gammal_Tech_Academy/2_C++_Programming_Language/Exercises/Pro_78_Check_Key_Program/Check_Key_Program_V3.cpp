...
void welcomeMassageFun()
{
     cout << endl
          << endl
          << "You welcome in Check Key Program ( Version 3 ) .." << endl
          << endl;
}
...
void checkKayFun(map<int, string> m)
{
     ...
     for (auto i : m)
     {
          if (i.first == 3 ) // Note: if (i == 3) -> Error .. Because 'i' it is indicator to 'm', and 'm' containing "first - int, second - string".
          {
