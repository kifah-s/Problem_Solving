...
/* >>> Monthly Expense Program ( Version 1 ) <<< */
...
int expenseAccount(int monthlyExpense, int boysPrimarySchool, int boysMyPreparation, int boysSecondarySchool);
...
int main()
{
    ...
    expenseAccount(monthlyExpense, boysPrimarySchool, boysMyPreparation, boysSecondarySchool);
...
void welcomeMassageFun()
{
    printf("\n\nYou welcome in Monthly Expense Program ( Version 1 ) ..\n\n");
}
