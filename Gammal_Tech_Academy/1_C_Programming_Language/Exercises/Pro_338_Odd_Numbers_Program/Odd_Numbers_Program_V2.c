...
int oddNumberFun(int arr[10], int posNumCounter, int posNumSums);
...
int main()
{
   ...
   */
    ...
    oddNumberFun(arr, oddNumCounter, oddNumSums);
...
// Odd number function;
int oddNumberFun(int arr[10], int oddNumCounter, int oddNumSums)
{
    printf("Odd numbers : \n");
    for (int i = 0; i < 10; i++)
    {
