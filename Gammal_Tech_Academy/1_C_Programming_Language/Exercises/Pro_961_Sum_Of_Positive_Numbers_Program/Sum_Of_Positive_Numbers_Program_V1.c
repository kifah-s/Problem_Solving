...
//* Sum Of Positive Numbers Program (Version 1).
...
int main()
{
    ...
    int numberOfElements = 0, myNumbers[100], sumOfPositiveNumbers = 0;
...
void welcomeMessageFun()
{
    printf("\n\nYou welcome in Sum Of Positive Numbers Program (Version 1) ..\n\n");
}
