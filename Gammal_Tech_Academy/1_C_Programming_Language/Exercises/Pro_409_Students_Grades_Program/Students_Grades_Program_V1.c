...
/* >>> Students Grades Program ( Version 1 ) <<< */
...
int nameAndGradeStudentsFun(char name[50], char grade[10]);
...
int main()
{
    ...
    nameAndGradeStudentsFun(name, grade);
    // printf("\nname: %s - grade: %s\n\n", name, grade); // Check.
...
void welcomeMassageFun()
{
    printf("\n\nYou welcome in Students Grades Program ( Version 1 ) ..\n\n");
}
...
// Get name and grade students / Function.
int nameAndGradeStudentsFun(char name[50], char grade[10])
{
