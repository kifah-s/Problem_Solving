...
/* >>> Students Grades Program ( Version 4 ) <<< */
...
int maleOrFemaleFun(int maleOrFemale, FILE *maleFile, FILE *femaleFile, char name[50], char grade[10]);
...
int main()
{
    ...
    maleOrFemaleFun(maleOrFemale, maleFile, femaleFile, name, grade);
...
void welcomeMassageFun()
{
    printf("\n\nYou welcome in Students Grades Program ( Version 4 ) ..\n\n");
}
