...
//* Define Macro 6 Program (Version 2).
...
// Using Define.
#define AVERAGE(p1, p2, p3) ((p1 + p2 + p3) / 3.0) // OR (p1 + p2 + p3) / 3
...
void welcomeMessageFun()
{
    printf("\n\nYou welcome in Define Macro 6 Program (Version 2) ..\n\n");
}
//* End Function ..
