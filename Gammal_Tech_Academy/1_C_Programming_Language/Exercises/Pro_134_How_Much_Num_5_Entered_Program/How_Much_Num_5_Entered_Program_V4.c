...
/* >>> How Much Num 5 Entered Program ( Version 4 ) <<< */
...
int howMuchNum5EnteredFun(int sum);
...
void welcomeMassageFun()
{
    printf("\n\nYou welcome in How Much Num 5 Entered Program ( Version 4 ) .. \n\n");
}
