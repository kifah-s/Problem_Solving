 ...
 * and then prompts the user to enter 5 positive numbers one by one.
 * Subtract each entered positive number from the total.
...
/*
! Input:
! 1) Please enter a number: 20
! 2) Please enter a number: -5
! 3) Please enter a number: -500
! 4) Please enter a number: 56
! 5) Please enter a number: 30
