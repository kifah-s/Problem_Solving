...
/* >>> Num 66535F From Hex To Dec Program ( Version 5 ) <<< */
...
int main()
{
    ...
    printf("66535F in hexadecimal = %d in decimal\n\n\n", hexadecimal_to_decimal("66535F"));
...
void welcomeMassageFun()
{
    printf("\n\nYou welcome in Num 66535F From Hex To Dec Program ( Version 5 ) ..\n\n");
}
