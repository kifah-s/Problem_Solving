...
/* >>> Number Analysis Program ( Version 2 ) <<< */
...
void numberAnalysisFun(int numberToBeAnalyzed, int numberOfNumber, int arr[numberOfNumber]);
...
int main()
{
    ...
    numberAnalysisFun(numberToBeAnalyzed, numberOfNumber, arr);
...
void welcomeMassageFun()
{
    printf("\n\nYou welcome in Number Analysis Program ( Version 2 ) ..\n\n");
}
