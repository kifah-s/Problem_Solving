...
void printingGreatestFun(int firstNum, int secondNum);
...
int main()
{
    ...
    printingGreatestFun(firstNum, secondNum);
...
void welcomeMassageFun()
{
    printf("\n\nYou welcome in Two Numbers Program ( Version 4 ) ..\n\n");
}
...
// Printing the greatest number function;
void printingGreatestFun(int firstNum, int secondNum)
{
