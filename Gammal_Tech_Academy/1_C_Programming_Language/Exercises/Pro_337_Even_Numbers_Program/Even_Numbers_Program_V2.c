...
int evenNumberFun(int arr[10], int posNumCounter, int posNumSums);
...
int main()
{
   ...
   */
    ...
    evenNumberFun(arr, eveNumCounter, eveNumSums);
...
int evenNumberFun(int arr[10], int eveNumCounter, int eveNumSums)
{
    printf("Even numbers : \n");
    for (int i = 0; i < 10; i++)
    {
