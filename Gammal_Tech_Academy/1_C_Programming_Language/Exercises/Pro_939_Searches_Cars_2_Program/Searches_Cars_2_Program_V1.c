...
//* Searches Cars 2 Program (Version 1).

/*
 * Write a program with a function to count the number of cars of a specific brand in an exhibition.
 */

/*
! Input:
! Please enter brand: Mazda

! Output:
! Number of car of brand Mazda: 1
*/
...
void welcomeMessageFun()
{
    printf("\n\nYou welcome in Searches Cars 2 Program (Version 1) ..\n\n");
}
