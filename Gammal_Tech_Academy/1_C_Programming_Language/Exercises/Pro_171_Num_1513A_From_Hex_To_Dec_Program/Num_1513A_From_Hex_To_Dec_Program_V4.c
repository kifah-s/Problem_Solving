...
/* >>> Num 1513A From Hex To Dec Program ( Version 4 ) <<< */
...
int main()
{
    printf("\n\nYou welcome in Num 1513A From Hex To Dec Program ( Version 4 ) ..\n\n");

    // Print the hexadecimal and decimal numbers
    printf("1513A in hexadecimal = %d in decimal\n\n\n", hexadecimal_to_decimal("1513A"));
