...
/* >>> Students Grades Avg Success or Failure Program ( Version 2 ) <<< */
...
void informationStudentFun(struct students student[5]);
...
void welcomeMassageFun()
{
    printf("\n\nYou welcome in Students Grades Avg Success or Failure Program ( Version 2 ) ..\n\n");
}

// Information student function;
void informationStudentFun(struct students student[5])
{
