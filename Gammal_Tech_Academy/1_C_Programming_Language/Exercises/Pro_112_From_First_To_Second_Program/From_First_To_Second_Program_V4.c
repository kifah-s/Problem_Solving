...
/* >>> From First To Second Program ( Version 4 ) <<< */
...
int fromFirstToSecondFun(int num_S, int num_B);
...
int main()
{
    ...
    fromFirstToSecondFun(num_S, num_B);
...
void welcomeMassageFun()
{
    printf("\n\nYou welcome in From First \' Smaller Number \' To Second \' Bigger Number \' Program ( Version 4 ) ..\n\n");
}
