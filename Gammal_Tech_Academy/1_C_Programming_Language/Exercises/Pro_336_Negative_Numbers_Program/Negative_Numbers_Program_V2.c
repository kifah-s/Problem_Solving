...
int negativeNumberFun(int arr[10], int posNumCounter, int posNumSums);
...
int main()
{
   ...
   */
    ...
    negativeNumberFun(arr, negNumCounter, negNumSums);
...
int negativeNumberFun(int arr[10], int negNumCounter, int negNumSums)
{
