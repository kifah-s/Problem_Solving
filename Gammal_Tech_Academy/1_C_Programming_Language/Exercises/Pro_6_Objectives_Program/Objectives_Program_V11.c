...
int main()
{
    ...
    printf("%s",objectives_fun());
    
    /* printf(engineer_fun()); */
    printf("%s",engineer_fun());
    
    /* printf(car_fun()); */
    printf("%s",car_fun());
    
    /* printf(traveling_fun()); */
    printf("%s",traveling_fun());
    
    /* printf(fitness_fun()); */
    printf("%s",fitness_fun());
...
char *welcome_massage_fun()
{
    char *wel_mas[] = {"\n\nYou welcome in Objectives Program ( Version 11 ) ..\n\n"};
    return *wel_mas;
}
