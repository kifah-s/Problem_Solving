...
/* >>> Any Num From Dec To Oct Program ( Version 7 ) <<< */
...
void welcomeMassageFun()
{
    printf("\n\nYou welcome in Any Num From Dec To Oct Program ( Version 7 ) ..\n\n");
}
...
// print decimal and octal number function;
int decimalAndOctalFun()
{
