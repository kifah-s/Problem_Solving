...
/* >>> Num 2315A From Hex To Dec Program ( Version 6 ) <<< */
...
void welcomeMassageFun()
{
    printf("\n\nYou welcome in Num 2315A From Hex To Dec Program ( Version 6 ) ..\n\n");
}
...
// print decimal number fuction;
int decimalNumberFun()
{
    // Print the hexadecimal and decimal numbers
    printf("2315A in hexadecimal = %d in decimal\n\n\n", hexadecimal_to_decimal("2315A"));
}