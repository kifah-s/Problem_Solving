...
//* Sum Updated Values Program (Version 2).
...
int sumArrayValuesFun(int arr[], int len, int sum);
...
int main()
{
    ...
    // Sum Array Values.
    sum = sumArrayValuesFun(myArray, mtArraylength, sum);
...
void welcomeMessageFun()
{
    printf("\n\nYou welcome in Sum Updated Values Program (Version 2) ..\n\n");
}
