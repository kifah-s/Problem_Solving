...
//* Swap Two Characters Using Pointers Program (Version 1).
...
void swapCharactersFun(char *firPoi, char *secPoi, char *temp);
...
void welcomeMessageFun()
{
    printf("\n\nYou welcome in Swap Two Characters Using Pointers Program (Version 1) ..\n\n");
}
