...
//* Maximum And Minimum 10 Program (Version 1).

/*
* Write a program that takes three numbers as input and finds the maximum and minimum using a function.
...
{
    printf("\n\nYou welcome in Maximum And Minimum 10 Program (Version 1) ..\n\n");
}
