...
/* >>> Any Num From Oct To Dec Program ( Version 7 ) <<< */
...
int octalAndDecimalNumberFun();

int main()
{
    welcomeMassageFun();
    octalAndDecimalNumberFun();
...
void welcomeMassageFun()
{
    printf("\n\nYou welcome in Any Num From Oct To Dec Program ( Version 7 ) ..\n\n");
}
...
// print octal and decimal number function;
int octalAndDecimalNumberFun()
{
