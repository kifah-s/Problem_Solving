...
/* >>> Num 524451 From Oct To Dec Program ( Version 7 ) <<< */
...
void welcomeMassageFun()
{
    printf("\n\nYou welcome in Num 524451 From Oct To Dec Program ( Version 7 ) ..\n\n");
}
...
int decimalNumberFun()
{
    long long decimal_number = convert_octal_to_decimal(524451);
