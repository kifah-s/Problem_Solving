...
//* Negative Numbers 4 Program (Version 1).

/*
 * Write a program to count the number of negative numbers in an array using a function.
 */
...
void welcomeMessageFun()
{
    printf("\n\nYou welcome in Negative Numbers 4 Program (Version 1) ..\n\n");
}
