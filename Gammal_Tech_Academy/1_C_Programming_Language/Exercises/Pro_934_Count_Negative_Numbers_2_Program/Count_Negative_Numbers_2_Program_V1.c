...
//* Count Negative Numbers 2 Program (Version 1).

/*
 * Write a program to count the number of negative numbers in an array using a do-while loop.
 */
...
void welcomeMessageFun()
{
    printf("\n\nYou welcome in Count Negative Numbers 2 Program (Version 1) ..\n\n");
}
