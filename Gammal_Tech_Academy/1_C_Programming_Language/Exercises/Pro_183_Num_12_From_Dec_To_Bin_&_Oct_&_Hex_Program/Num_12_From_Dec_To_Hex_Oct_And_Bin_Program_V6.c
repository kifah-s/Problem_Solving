...
/* >>> Num 12 From Dec To Hex, Oct And Bin Program ( Version 6 ) <<< */

/* >>> Convert Number (12) from decimal to hexadecimal, octal and binary. <<< */
...
void welcomeMassageFun()
{
    printf("\n\nYou welcome in Num 12 From Dec To Hex, Oct And Bin Program ( Version 6 ) ..\n\n");
}
