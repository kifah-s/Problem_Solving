...
//* Linked List Count Even Numbers Using Recursion Program (Version 2).
...
{
    cout << "\n\nYou welcome in Linked List Count Even Numbers Using Recursion Program (Version 2) ..\n"
         << endl;
}
...
int countEvenNumbersInLinkedListFun(Node *head)
{
    ...
    int count = countEvenNumbersInLinkedListFun(head->next);
    return (head->number % 2 == 0) ? count + 1 : count;
}
