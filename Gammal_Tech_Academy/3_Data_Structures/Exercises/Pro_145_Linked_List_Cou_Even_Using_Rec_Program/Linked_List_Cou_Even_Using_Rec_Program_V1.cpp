...
//* Linked List Count Even Numbers Using Recursion Program (Version 1).

/*
* Write a program to count and print the number of even numbers in the linked list using recursion.
...
{
    cout << "\n\nYou welcome in Linked List Count Even Numbers Using Recursion Program (Version 1) ..\n"
         << endl;
}
...
// Count Even Numbers In Linked List - Function.
int countEvenNumbersInLinkedListFun(Node *head)
{
    Node *temp = head;
    if (temp == NULL)
    {
    ...
    else
    {
        if (temp->number % 2 == 0)
        {
            return 1 + countEvenNumbersInLinkedListFun(temp->next);
        }
        else
        {
            return countEvenNumbersInLinkedListFun(temp->next);
        }
    }
}
...
void resultFun()
{
    ...
    cout << "\n--------------------" << endl;
    cout << "Number of even numbers: " << countEvenNumbersInLinkedListFun(head);
    cout << "\n--------------------" << endl;
