...
//* Double Linked List Even Number Program (Version 2).
...
int evenNumbersRecFun(Node *head)
{
    ...
    else
    {
        // if (head->data % 2 == 0)
        // {
        //     return 1 + evenNumbersRecFun(head->next);
        // }
        // else
        // {
        //     return evenNumbersRecFun(head->next);
        // }

        return (head->data % 2 == 0) ? 1 + evenNumbersRecFun(head->next) : evenNumbersRecFun(head->next);
    }
}
