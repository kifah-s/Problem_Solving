...
//* Linked List Numbers of Nodes Program (Version 1).
...
{
    cout << "\n\nYou welcome in Linked List Numbers of Nodes Program (Version 1) ..\n"
         << endl;
}
...
void numberOfNodesFun(Node *head)
{
    int count = 0;
    Node *temp = head;
    while (temp != NULL)
