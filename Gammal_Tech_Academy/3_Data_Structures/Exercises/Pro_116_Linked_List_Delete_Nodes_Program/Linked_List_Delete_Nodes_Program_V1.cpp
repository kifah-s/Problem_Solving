...
//* Linked List Delete Nodes Program (Version 1).

/*
* Write a program to delete all nodes from the linked list.
...
{
    cout << "\n\nYou welcome in Linked List Delete Nodes Program (Version 1) ..\n"
         << endl;
}
