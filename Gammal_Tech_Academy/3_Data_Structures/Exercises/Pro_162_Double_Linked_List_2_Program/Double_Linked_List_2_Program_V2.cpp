...
//* Double Linked List 2 Program (Version 2).
...
{
    cout << "\n\nYou welcome in Double Linked List 2 Program (Version 2) ..\n"
         << endl;
}
...
int sumElementsFun(Node *head)
{
    ...
    {
        return head->data + sumElementsFun(head->next);
    }
}
