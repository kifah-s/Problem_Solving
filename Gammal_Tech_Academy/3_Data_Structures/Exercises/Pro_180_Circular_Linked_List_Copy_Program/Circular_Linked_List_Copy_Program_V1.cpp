...
//* Circular Linked List Copy Program (Version 1).

/*
* Create a circular linked list with user-specified nodes
* and display the elements and Copy a circular linked list into another circular linked list.
...
! 11) Copy Circular Linked list and Show
! 12) Exit
...
! Circular Liked List copied successfully.
! Copied: 1 2 3
*/
...
{
    cout << "\n\nYou welcome in Circular Linked List Copy Program (Version 1) ..\n"
         << endl;
}
...
int displayMenuFun()
{
    ...
    cout << "1) Add" << endl
         ...
         << "7) Sum Nodes" << endl
         << "8) Check If Empty" << endl
         << "9) Found Max Number" << endl
         << "10) Calculate Average" << endl
         << "11) Copy Circular Linked list and Show" << endl
         << "12) Exit" << endl
...
// Found Max Number - Function.
void foundMaxNumberFun(Node *head)
{
    int max = head->number;
    Node *headTemporary = head;
    ...
    cout << "Max Number in Circular Linked List: " << max << endl;
}

// Calculate Average - Function.
void calculateAverageFun(Node *head)
{
    int counter = 0;
    float sum = 0;
...
// Copy Circular Liked List - Function.
Node *copyCircularLikedListFun(Node *originalHead)
{
    ...
    Node *originalCurrent = originalHead, *newHead = NULL, *newCurrent = NULL;

    do
    {
        Node *newNode = (Node *)malloc(sizeof(Node));
        newNode->number = originalCurrent->number;
    ...
    cout << "Circular Liked List copied successfully." << endl;
...
void handlingUserChoiceFun(Node *head)
{
    ...
    do
    {
        ...
        case 9:
            foundMaxNumberFun(head);
            break;

        case 10:
            calculateAverageFun(head);
            break;

        case 11:
            head = copyCircularLikedListFun(head);
            showNodesFun(head);
            break;
