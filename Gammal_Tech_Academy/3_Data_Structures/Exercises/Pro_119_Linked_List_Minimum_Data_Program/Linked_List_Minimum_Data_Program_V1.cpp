...
//* Linked List Minimum Data Program (Version 1).

/*
* Write a program to find and print the minimum data value in the linked list.
...
{
    cout << "\n\nYou welcome in Linked List Minimum Data Program (Version 1) ..\n"
         << endl;
}
