...
//* Linked List Count Odd Numbers Program (Version 1).

/*
* Write a program that counts the number of nodes containing odd numbers in a linked list.
...
{
    cout << "\n\nYou welcome in Linked List Count Odd Numbers Program (Version 1) ..\n"
         << endl;
}
