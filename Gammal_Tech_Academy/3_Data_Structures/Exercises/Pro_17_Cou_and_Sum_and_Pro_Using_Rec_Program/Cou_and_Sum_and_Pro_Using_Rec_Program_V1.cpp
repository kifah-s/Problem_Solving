...
//* Count and Sum and Product Odd Digits Using Recursion Program (Version 1).
...
{
    cout << "\n\nYou welcome in Count and Sum and Product Odd Digits Using Recursion Program (Version 1) ..\n"
         << endl;
}
...
void productOddDigitsRecFun(int num, int proOfOddDig)
{
    int lastDigit = 0;

    if (num == 0) // Base Case.
    {
        cout << "Product of Odd digits: " << proOfOddDig << endl;
        return;
    }
    else
    {
        ...
        productOddDigitsRecFun(num, proOfOddDig); // Recursive call.
    }
}
...
void resultFun()
{
    ...
    productOddDigitsRecFun(myNumber, productOfOddDigits);
