...
//* Dynamically Allocates Memory For Integer 2 Program (Version 1).
...
! Output:
! Odd numbers form 1 to 8 is: 1 3 5 7
*/
...
{
    cout << "\n\nYou welcome in Dynamically Allocates Memory For Integer 2 Program (Version 1) ..\n"
         << endl;
}
...
void printOddNumbersFun(int *intPtr, int numOfEle)
{
    cout << "Odd Numbers form 1 to " << *intPtr << " is: ";
...
void resultFun()
{
    ...
    printOddNumbersFun(integerPointer, numberOfElements);
