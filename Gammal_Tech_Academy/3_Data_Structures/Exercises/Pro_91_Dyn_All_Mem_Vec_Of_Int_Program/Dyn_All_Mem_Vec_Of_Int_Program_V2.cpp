...
//* Dynamically Allocates Memory Vector Of Integer Program (Version 2).
...
{
    cout << "\n\nYou welcome in Dynamically Allocates Memory Vector Of Integer Program (Version 2) ..\n"
         << endl;
}
...
{
    ptrToVec = (int *)realloc(ptrToVec, (numOfEle = numOfEle * 2) * sizeof(int));
