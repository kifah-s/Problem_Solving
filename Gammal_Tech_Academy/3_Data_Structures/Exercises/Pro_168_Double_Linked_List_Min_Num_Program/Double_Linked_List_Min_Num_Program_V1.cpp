...
//* Double Linked List Minimum Number Program (Version 1).
...
{
    cout << "\n\nYou welcome in Double Linked List Minimum Number Program (Version 1) ..\n"
         << endl;
}
...
void resultFun()
{
    ...
    Node *head = NULL;
    int numberOfElements = 0, value = 0, minimumNumber = 0;
    ...
    minimumNumber = head->data;

    cout << "\nMaximum Number: " << minimumNumbersRecFun(head, minimumNumber) << endl;
