...
//* Circular Linked List Max Program (Version 1).

/*
* Create a circular linked list with user-specified nodes
* and display the elements and Find the maximum element in a circular linked list.
...
{
    cout << "\n\nYou welcome in Circular Linked List Max Program (Version 1) ..\n"
         << endl;
}
