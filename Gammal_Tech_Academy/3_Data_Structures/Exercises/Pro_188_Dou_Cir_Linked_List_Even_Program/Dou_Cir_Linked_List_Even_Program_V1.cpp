...
//* Dou Cir Linked List Even Program (Version 1).

/*
* Write a program to count the number of even elements in a Double Circular Linked List.
...
{
    cout << "\n\nYou welcome in Dou Cir Linked List Even Program (Version 1) ..\n"
         << endl;
}
