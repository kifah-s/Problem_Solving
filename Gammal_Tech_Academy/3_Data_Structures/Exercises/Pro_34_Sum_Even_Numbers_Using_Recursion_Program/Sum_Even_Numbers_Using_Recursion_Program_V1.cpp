...
//* Sum Even Numbers Using Recursion Program (Version 1).
...
{
    cout << "\n\nYou welcome in Sum Even Numbers Using Recursion Program (Version 1) ..\n"
         << endl;
}
...
int sumEvenNumbersRecFun(int num, int sumEvenNum, int i = 2)
{
    if (i > num)
    {
        return sumEvenNum;
    ...
    else
    {
        ...
        return sumEvenNumbersRecFun(num, sumEvenNum, i + 1);
    }
}
