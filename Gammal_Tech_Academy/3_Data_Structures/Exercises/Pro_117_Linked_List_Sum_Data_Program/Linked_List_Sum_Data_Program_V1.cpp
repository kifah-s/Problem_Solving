...
//* Linked List Sum Data Program (Version 1).

/*
* Write a program to find and print the sum of all data values in the linked list.

! Output:
! Sum of data value: 20
*/
...
{
    cout << "\n\nYou welcome in Linked List Sum Data Program (Version 1) ..\n"
         << endl;
}
