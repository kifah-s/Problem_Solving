...
//* Linked List Largest Number Using Recursion Program (Version 1).

/*
* Write a program to find and print the largest number in the linked list using recursion.
...
{
    cout << "\n\nYou welcome in Linked List Largest Number Using Recursion Program (Version 1) ..\n"
         << endl;
}
...
// Largest Number In Linked List - Function.
int largestNumberInLinkedListFun(Node *head, int larNum)
{
    Node *temp = head;
    ...
    {
        if (temp->number > larNum)
        {
            larNum = temp->number;
        }

        return largestNumberInLinkedListFun(temp->next, larNum);
    }
}
...
void resultFun()
{
    ...
    int largestNumber = head->number;
    
    cout << "\n--------------------" << endl;
    cout << "Largest number: " << largestNumberInLinkedListFun(head, largestNumber);
    cout << "\n--------------------" << endl;
