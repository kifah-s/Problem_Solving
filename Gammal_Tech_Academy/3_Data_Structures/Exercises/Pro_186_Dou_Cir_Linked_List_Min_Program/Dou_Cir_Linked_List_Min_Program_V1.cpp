...
//* Dou Cir Linked List Min Program (Version 1).

/*
* Create a Double Circular Linked List and add nodes to it
* and Find the minimum element in the doubly linked list.
...
{
    cout << "\n\nYou welcome in Dou Cir Linked List Min Program (Version 1) ..\n"
         << endl;
}
