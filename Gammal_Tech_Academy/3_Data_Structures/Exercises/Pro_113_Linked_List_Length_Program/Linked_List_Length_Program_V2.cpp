...
//* Linked List Length Program (Version 2).
...
{
    cout << "\n\nYou welcome in Linked List Length Program (Version 2) ..\n"
         << endl;
}
...
void printLinkedListLengthFun(Node *head, Node *temp)
{
    int length = 0;
    temp = head;
    while (temp != NULL)
...
int resultFun()
{
    ...
    printLinkedListLengthFun(head, temporary);
