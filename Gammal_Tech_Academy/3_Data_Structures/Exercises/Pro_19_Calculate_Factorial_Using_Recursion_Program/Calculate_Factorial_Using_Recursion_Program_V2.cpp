...
//* Calculate Factorial Using Recursion Program (Version 2).
...
{
    cout << "\n\nYou welcome in Calculate Factorial Using Recursion Program (Version 2) ..\n"
         << endl;
}
...
int calculateFactorialUsingRecursionFun(int num, int fac)
{
    ...
    else
    {
        // fac = fac * num;
        // num = num - 1;
        return calculateFactorialUsingRecursionFun(num - 1, fac * num); // Recursive call.
    }
}
