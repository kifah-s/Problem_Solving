...
//* Count Number Of Digits Using Recursion Program (Version 2).
...
{
    cout << "\n\nYou welcome in Count Number Of Digits Using Recursion Program (Version 2) ..\n"
         << endl;
}
...
void resultFun()
{
    ...
    numberOfDigits = countNumberOfDigitsRecFun(myNumber, numberOfDigits);
