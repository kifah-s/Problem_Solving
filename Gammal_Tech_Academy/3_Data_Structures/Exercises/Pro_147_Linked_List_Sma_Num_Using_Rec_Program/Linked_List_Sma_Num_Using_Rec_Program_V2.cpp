...
//* Linked List Smallest Number Using Recursion Program (Version 2).
...
{
    cout << "\n\nYou welcome in Linked List Smallest Number Using Recursion Program (Version 2) ..\n"
         << endl;
}
...
int smallestNumberInLinkedListFun(Node *head, int smaNum)
{
    ...
    // return smallestNumberInLinkedListFun(temp->next, (smaNum < temp->number) ? smaNum : temp->number);
    return smallestNumberInLinkedListFun(temp->next, (temp->number < smaNum) ? temp->number : smaNum);
}
...
void resultFun()
{
    ...
    cout << "\n--------------------" << endl;
    cout << "Smallest number: " << smallestNumberInLinkedListFun(head, head->number);
    cout << "\n--------------------" << endl;
