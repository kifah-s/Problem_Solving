...
//* Dynamically Allocates Memory For Array Of Char Program (Version 4).
...
{
    cout << "\n\nYou welcome in Dynamically Allocates Memory For Array Of Char Program (Version 4) ..\n"
         << endl;
}
