...
//* Ascending Order Using Recursion Program (Version 1).
...
{
    cout << "\n\nYou welcome in Ascending Order Using Recursion Program (Version 1) ..\n"
         << endl;
}
...
void ascendingOrderRecFun(int num, int negTwo)
{
    ...
    else
    {
        cout << negTwo << " ";
        negTwo++;
        return ascendingOrderRecFun(num, negTwo);
    }
}
