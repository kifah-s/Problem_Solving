...
//* Ascending Order Using Recursion Program (Version 4).
...
{
    cout << "\n\nYou welcome in Ascending Order Using Recursion Program (Version 4) ..\n"
         << endl;
}
...
void ascendingOrderRecFun(int num)
{
    if (num > -3)
    {
        ascendingOrderRecFun(num - 1);
        cout << num << " ";
    }
}
