...
//* Double Linked List Search Using Recursion Program (Version 3).
...
{
    cout << "\n\nYou welcome in Double Linked List Search Using Recursion Program (Version 3) ..\n"
         << endl;
}
...
bool foundNumbersRecFun(Node *head, int num)
{
    if (head == NULL)
    {
        return 0;
    ...
    {
        return (head->data == num) ? 1 : foundNumbersRecFun(head->next, num);
    }
}
