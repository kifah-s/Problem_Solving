...
//* Double Linked List Search Using Recursion Program (Version 2).
...
{
    cout << "\n\nYou welcome in Double Linked List Search Using Recursion Program (Version 2) ..\n"
         << endl;
}
...
bool foundNumbersRecFun(Node *head, int num)
{
    ...
    else
    {
        ...
        return foundNumbersRecFun(head->next, num);
    }
}
