...
//* Double Linked List Search Using Recursion Program (Version 1).

/*
* Write a program to search for a specific element in a double linked list.
...
! Please, enter element to search: 4
...
{
    cout << "\n\nYou welcome in Double Linked List Search Using Recursion Program (Version 1) ..\n"
         << endl;
}
...
// Found Numbers - Recursion Function.
bool foundNumbersRecFun(Node *head, int num, bool found = false)
{
    if (head == NULL)
    {
        return found;
    ...
    else
    {
        ...
        return foundNumbersRecFun(head->next, num, found);
    }
}
...
void resultFun()
{
    ...
    if (foundNumbersRecFun(head, numberToSearch))
    {
        cout << "\n"
             << numberToSearch << " is found in list." << endl;
    }
    else
    {
        cout << "\n"
             << numberToSearch << " is not found in list." << endl;
    }
