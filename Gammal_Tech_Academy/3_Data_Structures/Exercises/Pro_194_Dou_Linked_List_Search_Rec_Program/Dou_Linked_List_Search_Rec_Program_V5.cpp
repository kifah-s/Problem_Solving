...
//* Double Linked List Search Using Recursion Program (Version 5).
...
{
    cout << "\n\nYou welcome in Double Linked List Search Using Recursion Program (Version 5) ..\n"
         << endl;
}
...
int foundNumbersRecFun(Node *head, int num)
{
    if (head == NULL)
    {
        return 0;
