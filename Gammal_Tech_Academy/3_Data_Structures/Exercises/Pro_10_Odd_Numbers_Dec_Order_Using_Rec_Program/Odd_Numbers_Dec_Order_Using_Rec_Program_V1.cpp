...
//* Odd Numbers Decreasing Order Using Recursion Program (Version 1).

/*
* Write a program that prompts the user to enter an integer 'num' and then,
* prints the odd numbers from 'num' to 1 in decreasing order.

! Input:
! Please, enter a number: 8

! Output:
! Even Numbers from 1 to 8: 7 5 3 1
*/
...
{
    cout << "\n\nYou welcome in Odd Numbers Decreasing Order Using Recursion Program (Version 1) ..\n"
         << endl;
}
