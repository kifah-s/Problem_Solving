...
//* Dou Cir Linked List Delete Program (Version 1).

/*
* Create a Double Circular Linked List and add nodes to it and Delete all nodes from the doubly linked list.
...
! Double circular linked list is empty.
*/
...
{
    cout << "\n\nYou welcome in Dou Cir Linked List Delete Program (Version 1) ..\n"
         << endl;
}
