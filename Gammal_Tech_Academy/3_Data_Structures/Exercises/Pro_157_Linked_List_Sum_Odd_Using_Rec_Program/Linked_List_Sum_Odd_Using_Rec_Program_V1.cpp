...
//* Linked List Sum Odd Using Recursion Program (Version 1).

/*
* Write a program to find and print the sum of all odd numbers in the linked list.
...
{
    cout << "\n\nYou welcome in Linked List Sum Odd Using Recursion Program (Version 1) ..\n"
         << endl;
}
...
// Sum Odd Numbers - Recursion Function.
int sumOddNumbersRecFun(Node *head)
{
    Node *temp = head;
    if (temp == NULL)
    {
    ...
    int sum = sumOddNumbersRecFun(temp->next);
    return (temp->number % 2 != 0) ? sum + temp->number : sum;
}
...
void resultFun()
{
    ...
    cout << "\n--------------------" << endl;
    cout << "Sum Odd Numbers: " << sumOddNumbersRecFun(head);
    cout << "\n--------------------" << endl;
