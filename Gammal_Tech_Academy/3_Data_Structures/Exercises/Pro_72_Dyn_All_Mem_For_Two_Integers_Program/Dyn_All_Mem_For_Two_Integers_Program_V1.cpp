...
//* Dynamically Allocates Memory For Two Integers Program (Version 1).

/*
* Write a program to dynamically allocate memory for two integers and initialize them with values 10 and 20.
* And using free.
...
{
    cout << "\n\nYou welcome in Dynamically Allocates Memory For Two Integers Program (Version 1) ..\n"
         << endl;
}
