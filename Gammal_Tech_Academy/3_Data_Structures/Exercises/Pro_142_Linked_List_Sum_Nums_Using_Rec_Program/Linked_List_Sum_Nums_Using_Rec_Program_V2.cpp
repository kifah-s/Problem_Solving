...
//* Linked List Sum Numbers Using Recursion Program (Version 2).

/*
* Write a program to find and print the sum of all numbers in the linked list using recursion.
...
{
    cout << "\n\nYou welcome in Linked List Sum Numbers Using Recursion Program (Version 2) ..\n"
         << endl;
}
...
// Sum Number In Linked List - Function.
int sumNumberInLinkedListFun(Node *head)
{
    Node *temp = head;
    if (temp == NULL)
    {
    ...
    {
        return temp->number + sumNumberInLinkedListFun(temp->next);
    }
}
...
void resultFun()
{
    ...
    cout << "\n--------------------" << endl;
    cout << "Sum Numbers: " << sumNumberInLinkedListFun(head);
    cout << "\n--------------------" << endl;
