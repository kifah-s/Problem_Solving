...
//* Linked List Sum Numbers Using Recursion Program (Version 1).
...
{
    cout << "\n\nYou welcome in Linked List Sum Numbers Using Recursion Program (Version 1) ..\n"
         << endl;
}
...
void sumNumberInLinkedListFun(Node *head)
{
    int sumNum = 0;
    ...
    while (temp != NULL)
    {
        sumNum = sumNum + temp->number;
        temp = temp->next;
    }
    
    cout << "\n--------------------" << endl;
    cout << "Sum Numbers: " << sumNum;
    cout << "\n--------------------" << endl;
}
