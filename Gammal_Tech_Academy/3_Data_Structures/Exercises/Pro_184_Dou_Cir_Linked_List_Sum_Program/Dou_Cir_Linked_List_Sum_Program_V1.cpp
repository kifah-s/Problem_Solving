...
//* Dou Cir Linked List Sum Program (Version 1).

/*
* Create a Double Circular Linked List and add nodes to it
* and Calculate the sum of all nodes in the doubly linked list.
...
{
    cout << "\n\nYou welcome in Dou Cir Linked List Sum Program (Version 1) ..\n"
         << endl;
}
