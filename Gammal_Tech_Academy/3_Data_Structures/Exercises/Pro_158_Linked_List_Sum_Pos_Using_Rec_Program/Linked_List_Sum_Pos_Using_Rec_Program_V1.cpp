...
//* Linked List Sum Positive Using Recursion Program (Version 1).

/*
* Write a program to find and print the sum of all positive numbers in the linked list.
...
{
    cout << "\n\nYou welcome in Linked List Sum Positive Using Recursion Program (Version 1) ..\n"
         << endl;
}
...
// Sum Positive Numbers - Recursion Function.
int sumPositiveNumbersRecFun(Node *head)
{
    Node *temp = head;
    if (temp == NULL)
    {
    ...
    int sum = sumPositiveNumbersRecFun(temp->next);
    return (temp->number > 0) ? sum + temp->number : sum;
}
...
void resultFun()
{
    ...
    cout << "\n--------------------" << endl;
    cout << "Sum Positive Numbers: " << sumPositiveNumbersRecFun(head);
    cout << "\n--------------------" << endl;
