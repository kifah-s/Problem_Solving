...
//* Double Linked List 6 Program (Version 4).
...
{
    cout << "\n\nYou welcome in Double Linked List 6 Program (Version 4) ..\n"
         << endl;
}
...
int occurrencesOfNumbersRecFun(Node *head, int num)
{
    ...
    int count = (head->data == num) ? 1 : 0;
    return count + occurrencesOfNumbersRecFun(head->next, num);
}
