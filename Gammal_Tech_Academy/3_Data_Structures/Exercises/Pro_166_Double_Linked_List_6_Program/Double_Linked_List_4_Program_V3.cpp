...
//* Double Linked List 6 Program (Version 3).
...
{
    cout << "\n\nYou welcome in Double Linked List 6 Program (Version 3) ..\n"
         << endl;
}
...
int occurrencesOfNumbersRecFun(Node *head, int num)
{
    ...
    {
        return (head->data == num) ? 1 + occurrencesOfNumbersRecFun(head->next, num) : occurrencesOfNumbersRecFun(head->next, num);
    }
}
