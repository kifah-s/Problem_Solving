...
//* Linked List Product Number Using Recursion Program (Version 1).

/*
* Write a program to find and print the product of all numbers less than a given value in the linked list using recursion.
...
! Enter number: 3
! Enter number: 4
! Please, enter the threshold value: 3

! Output:
! Product of numbers less than 3: 2
*/
...
{
    cout << "\n\nYou welcome in Linked List Product Number Using Recursion Program (Version 1) ..\n"
         << endl;
}
...
// Product Of Numbers Less Than Threshold Value - Recursion Function.
int productOfNumbersLessThanThresholdValueRecFun(Node *head, int thrVal)
{
    Node *temp = head;
    if (temp == NULL)
    {
    ...
    int product = productOfNumbersLessThanThresholdValueRecFun(temp->next, thrVal);
    return (temp->number < thrVal) ? product * temp->number : product;
}
...
void resultFun()
{
    ...
    cout << "\n--------------------" << endl;
    cout << "Product of numbers Less than " << thresholdValue << ": " << productOfNumbersLessThanThresholdValueRecFun(head, thresholdValue);
    cout << "\n--------------------" << endl;
