...
//* Dynamically Allocates Memory For Integers Array 3 Program (Version 2).
...
{
    cout << "\n\nYou welcome in Dynamically Allocates Memory For Integers Array 3 Program (Version 2) ..\n"
         << endl;
}
