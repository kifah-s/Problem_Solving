...
//* Sum Natural Numbers Using Recursion Program (Version 3).
...
{
    cout << "\n\nYou welcome in Sum Natural Numbers Using Recursion Program (Version 3) ..\n"
         << endl;
}
...
int sumNaturalNumbersRecFun(int num, int i = 0)
{
    // for (int i = 0; i <= num; i++)
    // {
    ...
    else
    {
        ...
        return i + sumNaturalNumbersRecFun(num, i + 1); // Recursive Call.
    }
}
