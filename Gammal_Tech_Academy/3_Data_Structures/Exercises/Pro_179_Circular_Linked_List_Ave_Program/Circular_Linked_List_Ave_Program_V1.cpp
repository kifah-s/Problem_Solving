...
//* Circular Linked List Ave Program (Version 1).

/*
* Create a circular linked list with user-specified nodes
* and display the elements and Calculate the average of all nodes in a circular linked list.
...
{
    cout << "\n\nYou welcome in Circular Linked List Ave Program (Version 1) ..\n"
         << endl;
}
