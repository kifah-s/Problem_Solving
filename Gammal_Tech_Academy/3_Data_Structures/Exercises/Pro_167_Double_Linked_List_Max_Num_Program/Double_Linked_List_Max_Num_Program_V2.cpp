...
//* Double Linked List Maximum Number Program (Version 2).
...
{
    cout << "\n\nYou welcome in Double Linked List Maximum Number Program (Version 2) ..\n"
         << endl;
}
...
int maximumNumbersRecFun(Node *head)
{
    if (head == NULL)
    {
    ...
    int max = maximumNumbersRecFun(head->next);
...
void resultFun()
{
    ...
    cout << "\nMaximum Number: " << maximumNumbersRecFun(head) << endl;
