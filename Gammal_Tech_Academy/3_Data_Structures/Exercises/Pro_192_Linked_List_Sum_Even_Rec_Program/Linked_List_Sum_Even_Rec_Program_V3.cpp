...
//* Linked List Sum Even Using Recursion Program (Version 3).
...
{
    cout << "\n\nYou welcome in Linked List Sum Even Using Recursion Program (Version 3) ..\n"
         << endl;
}
...
int sumEvenNumbersRecFun(Node *head)
{
    ...
    {
        int sum = sumEvenNumbersRecFun(temp->next);
