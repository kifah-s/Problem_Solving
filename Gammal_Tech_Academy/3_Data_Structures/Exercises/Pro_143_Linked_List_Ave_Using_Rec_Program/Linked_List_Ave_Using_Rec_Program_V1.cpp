...
//* Linked List Calculate Average Using Recursion Program (Version 1).
...
{
    cout << "\n\nYou welcome in Linked List Calculate Average Using Recursion Program (Version 1) ..\n"
         << endl;
}
...
// Sum Numbers In Linked List - Function.
float sumNumberInLinkedListFun(Node *head)
{
    Node *temp = head;
    if (temp == NULL)
    {
...
void resultFun()
{
    ...
    cout << "\n--------------------" << endl;
    cout << "Average of numbers: " << sumNumberInLinkedListFun(head) / NumberOfNumbersInLinkedList;
    cout << "\n--------------------" << endl;
