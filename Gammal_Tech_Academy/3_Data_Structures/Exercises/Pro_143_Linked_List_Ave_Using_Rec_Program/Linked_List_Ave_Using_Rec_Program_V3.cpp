...
//* Linked List Calculate Average Using Recursion Program (Version 3).
...
{
    cout << "\n\nYou welcome in Linked List Calculate Average Using Recursion Program (Version 3) ..\n"
         << endl;
}
...
float calculateAverageInLinkedListFun(Node *head, float sum, int count)
{
    Node *temp = head;
    if (temp == NULL)
    {
...
void resultFun()
{
    ...
    cout << "\n--------------------" << endl;
    cout << "Average of numbers: " << calculateAverageInLinkedListFun(head, 0, 0);
    cout << "\n--------------------" << endl;
