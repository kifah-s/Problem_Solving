...
//* Linked List Sum Even Using Recursion Program (Version 2).
...
{
    cout << "\n\nYou welcome in Linked List Sum Even Using Recursion Program (Version 2) ..\n"
         << endl;
}
...
// Sum Of Even - Recursion Function.
int sumOfEvenRecFun(Node *head)
{
    Node *temp = head;
    if (temp == NULL)
    {
    ...
    {
        int sum = sumOfEvenRecFun(temp->next);
...
void resultFun()
{
    ...
    cout << "\n--------------------" << endl;
    cout << "Sum Of Even: " << sumOfEvenRecFun(head);
    cout << "\n--------------------" << endl;
