...
//* Sum and Count Odd Digits Using Recursion Program (Version 1).
...
{
    cout << "\n\nYou welcome in Sum and Count Odd Digits Using Recursion Program (Version 1) ..\n"
         << endl;
}
...
int sumOddDigitsRecFun(int num, int sumDig)
{
    if (num == 0)
    {
        return sumDig;
...
void resultFun()
{
    ...
    sumDigits = sumOddDigitsRecFun(number, sumDigits);
    cout << "Sum of odd digits: " << sumDigits << endl;
