...
//* Sum and Count Odd Digits Using Recursion Program (Version 2).
...
{
    cout << "\n\nYou welcome in Sum and Count Odd Digits Using Recursion Program (Version 2) ..\n"
         << endl;
}
...
void resultFun()
{
    ...
    cout << "Sum of odd digits: " << sumOddDigitsRecFun(number, sumDigits) << endl;
