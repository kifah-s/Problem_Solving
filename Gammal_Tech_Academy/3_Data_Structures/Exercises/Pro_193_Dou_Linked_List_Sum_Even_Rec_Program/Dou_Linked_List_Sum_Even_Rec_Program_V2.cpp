...
//* Double Linked List Sum Even Number Using Recursion Program (Version 2).
...
{
    cout << "\n\nYou welcome in Double Linked List Sum Even Number Using Recursion Program (Version 2) ..\n"
         << endl;
}
...
int sumEvenNumbersFun(Node *head)
{
    ...
    {
        return (head->data % 2 == 0) ? head->data + sumEvenNumbersFun(head->next) : sumEvenNumbersFun(head->next);
    }
}
