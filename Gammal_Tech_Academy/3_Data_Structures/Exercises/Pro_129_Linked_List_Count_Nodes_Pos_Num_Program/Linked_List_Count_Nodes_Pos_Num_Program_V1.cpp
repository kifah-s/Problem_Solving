...
//* Linked List Count Nodes Positive Number Program (Version 1).

/*
* Write a program that counts the number of nodes containing positive numbers in a linked list.
...
! 9) Count Nodes Which Contains Positive Numbers
! 10) Count Specific Numbers
! 11) Exit
...
! ----------------------------
! Number of nodes with positive numbers: 2
! ----------------------------
*/
...
{
    cout << "\n\nYou welcome in Linked List Count Nodes Positive Number Program (Version 1) ..\n"
         << endl;
}
...
int displayMenuFun()
{
    ...
    cout << "1) Add" << endl
         ...
         << "9) Count Nodes Which Contains Positive Numbers" << endl
         << "10) Count Specific Numbers" << endl
         << "11) Exit" << endl
...
// Nodes Which Contains Positive Numbers - Function
void nodesWhichContainsPositiveNumbersFun(Node *head)
{
    int counter = 0;
    ...
    cout << "----------------------------" << endl;
    cout << "Nodes which contains positive numbers: " << counter << endl;
    cout << "----------------------------" << endl;
}
...
void handlingUserChoiceFun(Node *head)
{
    ...
    do
    {
        ...
        case 9:
            nodesWhichContainsPositiveNumbersFun(head);
            break;
